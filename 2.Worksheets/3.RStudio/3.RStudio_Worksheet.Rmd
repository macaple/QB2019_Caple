...
> Answer 1: 'rnorm' generates random values that follow a normal distribution-- but default, 
> they follow a distribution with mean = 0 and standard deviation = 1. The three arguments
> are: the number of random numbers generated, the mean of the distribution, and the standard
